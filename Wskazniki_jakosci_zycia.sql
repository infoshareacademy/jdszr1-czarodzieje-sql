...
-- CZÊŒÆ FINANSOWA, WYTYPOWANIE KRAJÓW DO ANALIZY JAKOŒCI ¯YCIA - te same, co do analizy œrodowiskowej
...
select avg(LEB) from leb -- 67,70% - œrednia dla wszystkich pañstw we wszystkich latach
...
select avg(edu) from edu -- 15% - œrednia dla wszystkich pañstw we wszystkich latach
